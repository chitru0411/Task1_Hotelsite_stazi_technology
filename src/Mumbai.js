...
import MumbaiData from './MumbaiData';
...
const slice = MumbaiData.slice(0,noOfElement);
  return (
    <>
         ...
         investment oppourtinity.the value of real estate can be</h2>
            <nav className='nav_bar'>
                 ...
                 <li role='presentation' > <a href='/' aria-controls='newyork' role='tab' data-toggle="tab">NewYork</a></li>
                     <li role='presentation' className='active'><a href='/mumbai' target='_blank'  aria-controls='mumbai' role='tab' data-toggle="tab">Mumbai</a></li>
                     <li role='presentation'><a href='/paris' target='_blank'  aria-controls='paris' role='tab' data-toggle="tab">Paris</a></li>
                    <li role='presentation' ><a href='/london' target='_blank'  aria-controls='london' role='tab' data-toggle="tab">London</a></li>
                 </ul>
            </nav>
