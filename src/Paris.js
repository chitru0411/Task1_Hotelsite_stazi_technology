...
const slice = ParisData.slice(0,noOfElement);
      ...
      <div className='main_div'>
               ...
               <nav className='nav_bar'>
                 ...
                 <li role='presentation' > <a href='/' aria-controls='newyork' role='tab' data-toggle="tab">NewYork</a></li>
                     ...
                     <li role='presentation' className='active'><a href='/paris' target='_blank'  aria-controls='paris' role='tab' data-toggle="tab">Paris</a></li>
